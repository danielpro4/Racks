...
(function (latte) {
    ...
    var Element = /** @class */ (function () {
        ...
        Element.create = function (tagName) {
            ...
            parts.forEach(function (p) { return element.addClass(p); });
            return element;
        };
        /**
        ...
        Element.getDocumentHeight = function (d) {
            if (d === void 0) { d = null; }
            var doc = (d || document).documentElement;
        ...
        Element.prototype.bind = function (object, hide) {
            ...
            var plist = this.raw.querySelectorAll('[data-property]');
            plist.forEach(function (node) {
                if (node instanceof HTMLElement) {
                    var pname_1 = node.getAttribute('data-property');
                    var props = Object.getOwnPropertyNames(Object.getPrototypeOf(_this));
                    props.forEach(function (inner) {
                        if (inner.indexOf(pname_1 + '_') === 0) {
                            var eventName = inner.substr(pname_1.length + 1);
                            node.addEventListener(eventName, function (e) { return _this[inner](e); });
                        }
                    });
                }
            });
         ...
         * @param object
         */
        Element.prototype.removeBindedElement = function (object) {
            var dataCount = 0;
            // Scan data bindings
            this.dataBinds.forEach(function (bind) {
                bind.uninstall();
                dataCount++;
            });
        ...
        Element.prototype.removeClass = function (className) {
            ...
            // Add all classes
            parts.forEach(function (p) { return _this.element.classList.remove(p); });
        };
        /**
...
(function (latte) {
     ...
     */
    var LocalEditor = /** @class */ (function () {
        //endregion
        /**
         * Creates the editor
         */
        function LocalEditor(element, edited, cancelled, finished) {
            if (edited === void 0) { edited = null; }
            if (cancelled === void 0) { cancelled = null; }
            if (finished === void 0) { finished = null; }
            //endregion
            //region Fields
            this._editingValue = false;
            this._editEventsAdded = false;
            this._oldTitle = null;
            /**
             * Property field
             */
         ...
         */
        LocalEditor.onClick = function (element, edited, cancelled, finished) {
            if (edited === void 0) { edited = null; }
            if (cancelled === void 0) { cancelled = null; }
            if (finished === void 0) { finished = null; }
            var editor = new LocalEditor(element, edited, cancelled, finished);
         ...
         */
        LocalEditor.prototype.cancel = function () {
            if (this.editionMode) {
         ...
         * Ends Edition Mode
         */
        LocalEditor.prototype.endEditMode = function (success) {
         ...
         */
        LocalEditor.prototype.onCancelled = function () {
            if (this._cancelled) {
         ...
         */
        LocalEditor.prototype.onEdited = function () {
            if (this._edited) {
                this._edited.raise();
            }
            this.onFinished();
         ...
         */
        LocalEditor.prototype.onEnabledChanged = function () {
         ...
         */
        LocalEditor.prototype.onFinished = function () {
            if (this._finished) {
         ...
         * Starts edit mode
         */
        LocalEditor.prototype.startEditMode = function () {
            var _this = this;
            if (!this.enabled) {
                return;
            }
            ...
            if (!this._editEventsAdded) {
                ...
                t.addEventListener('keydown', function (e) {
                    if (e.keyCode == latte.Key.ENTER || e.keyCode == latte.Key.ESCAPE) {
                        if (_this._editingValue) {
                            e.preventDefault();
                            e.stopPropagation();
                            e.stopImmediatePropagation();
                            _this.endEditMode(e.keyCode == latte.Key.ENTER);
                        }
                    }
                });
            ...
            setTimeout(function () { return t.focus(); }, 0);
            setTimeout(function () { return document.execCommand('selectAll', false, null); }, 0);
        };
        Object.defineProperty(LocalEditor.prototype, "cancelled", {
            /**
            ...
            get: function () {
                if (!this._cancelled) {
                    this._cancelled = new latte.LatteEvent(this);
                }
        ...
        Object.defineProperty(LocalEditor.prototype, "finished", {
            /**
            ...
            get: function () {
                if (!this._finished) {
                    this._finished = new latte.LatteEvent(this);
                }
        ...
        Object.defineProperty(LocalEditor.prototype, "edited", {
            /**
            ...
            get: function () {
                if (!this._edited) {
                    this._edited = new latte.LatteEvent(this);
                }
                return this._edited;
            },
            enumerable: true,
        ...
        Object.defineProperty(LocalEditor.prototype, "enabledChanged", {
            /**
            ...
            get: function () {
                if (!this._enabledChanged) {
                    this._enabledChanged = new latte.LatteEvent(this);
                }
        ...
        Object.defineProperty(LocalEditor.prototype, "editionMode", {
            //endregion
            //region Properties
            /**
        ...
        Object.defineProperty(LocalEditor.prototype, "element", {
            /**
        ...
        Object.defineProperty(LocalEditor.prototype, "enabled", {
            /**
...
/// <reference path="/Users/daniel/Projects/Racks/latte/latte.element/support/ts-include/latte.data.strings.d.ts" />
